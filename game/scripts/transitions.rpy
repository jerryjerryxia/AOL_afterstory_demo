...
init python:
    ...
    def glitch_fx():
        ...
        pool = [fx for fx in GLITCH_FX if fx is not _glitch_fx_last[0]] or GLITCH_FX
        fx = renpy.random.choice(pool)
        _glitch_fx_last[0] = fx
        return fx(seed=renpy.random.random() * 100.0)
