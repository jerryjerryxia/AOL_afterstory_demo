...
```bash
"X:\RenPy\renpy-8.5.0-sdk\renpy.exe" "X:\GameDev\EndlessSummerSyndromeDemo" lint 2>&1
```
...
```bash
cd "X:\GameDev\EndlessSummerSyndromeDemo"
rm -f preflight_test.txt
"X:\RenPy\renpy-8.5.0-sdk\renpy.exe" "X:\GameDev\EndlessSummerSyndromeDemo" test --report-detailed > preflight_test.txt 2>&1 &
...
```
Read: X:\GameDev\EndlessSummerSyndromeDemo\traceback.txt
```
